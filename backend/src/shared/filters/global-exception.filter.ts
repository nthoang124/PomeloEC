...
export class GlobalExceptionFilter implements ExceptionFilter {
    ...
    if (exception instanceof ZodValidationException) {
      ...
      const zodError = exception.getZodError() as unknown as { errors: Array<{ path: string[], message: string }> };
      ...
      errorCode = typeof exceptionResponse.error === 'string' ? exceptionResponse.error : typeof exceptionResponse.code === 'string' ? exceptionResponse.code : HttpStatus[status].toString();
